...
export default [
  ...
  {
    path: '/el-form/docs',
    component: ComponentCreator('/el-form/docs', '3a4'),
    routes: [
      {
        path: '/el-form/docs',
        component: ComponentCreator('/el-form/docs', '819'),
        routes: [
          {
            path: '/el-form/docs',
            component: ComponentCreator('/el-form/docs', '4ac'),
            routes: [
              {
              ...
              {
                path: '/el-form/docs/nested-arrays',
                component: ComponentCreator('/el-form/docs/nested-arrays', '6f5'),
                exact: true,
                sidebar: "docs"
              },
              {
